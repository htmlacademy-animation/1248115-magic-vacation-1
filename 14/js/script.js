...
/* harmony import */ var _show_remaining_time__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./show-remaining-time */ "./source/js/modules/show-remaining-time.js");
/* harmony import */ var _show_animate_prizes__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./show-animate-prizes */ "./source/js/modules/show-animate-prizes.js");
...
class FullPageScroll {
  ...
  changeVisibilityDisplay() {
    ...
    if (this.screenElements[this.activeScreen].id === "game") {
      if (!_show_remaining_time__WEBPACK_IMPORTED_MODULE_1__["done"]) {
        setTimeout(_show_remaining_time__WEBPACK_IMPORTED_MODULE_1__["startTimer"], 200);
      }
    }
    if (this.screenElements[this.activeScreen].id === "prizes") {
      Object(_show_animate_prizes__WEBPACK_IMPORTED_MODULE_2__["showAnimatePrizes"])();
    }
...
/***/ "./source/js/modules/get-animated-titles.js":
/*!**************************************************!*\
  !*** ./source/js/modules/get-animated-titles.js ***!
  \**************************************************/
/*! exports provided: getAnimatedTitles */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getAnimatedTitles", function() { return getAnimatedTitles; });
/* harmony import */ var _user_data__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./user-data */ "./source/js/modules/user-data.js");
...
const getAnimatedTitles = () => {
  _user_data__WEBPACK_IMPORTED_MODULE_0__["animatedResultTitleData"].forEach((itemTitle) => {
...
/* harmony import */ var _user_data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./user-data */ "./source/js/modules/user-data.js");
...
const loadPage = ()  => {
  ...
  screenElements.forEach((screen) => {
    if (_user_data__WEBPACK_IMPORTED_MODULE_1__["sectionHasTransitionEnd"].includes(screen.id)) {
      screen.setAttribute('data-transition-end', screen.id);
    }
  });

  _user_data__WEBPACK_IMPORTED_MODULE_1__["accentTypographyData"].forEach((item) => new _accent_typography_build__WEBPACK_IMPORTED_MODULE_0__["AccentTypographyBuild"](
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _show_remaining_time__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./show-remaining-time */ "./source/js/modules/show-remaining-time.js");
/* harmony import */ var _scene_2d_sea_calf_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scene-2d-sea-calf.js */ "./source/js/modules/scene-2d-sea-calf.js");
  ...
  if (results.length) {
    for (let i = 0; i < showResultEls.length; i++) {
      showResultEls[i].addEventListener(`click`, function () {
        Object(_show_remaining_time__WEBPACK_IMPORTED_MODULE_0__["stopTimer"])();
        ...
        if (target === 'result') {
          new _scene_2d_sea_calf_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
        }
        if (target === 'result3') {
    ...
    if (playBtn) {
      playBtn.addEventListener(`click`, function () {
        ...
        setTimeout(_show_remaining_time__WEBPACK_IMPORTED_MODULE_0__["startTimer"], 200);
      });
    }
  }
});
...
class Scene2DCrocodile extends _scene_2d_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  ...
  initKeyAnimations() {
    this.animations.push(new _animation_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
      ...
      duration: 200,
      delay: 166,
      easing: _utils_js__WEBPACK_IMPORTED_MODULE_2__["default"].easeLinear
    }));
  }
  ...
  initWatermelonAnimations() {
    this.animations.push(new _animation_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
      ...
      duration: 66,
      delay: 233,
      easing: _utils_js__WEBPACK_IMPORTED_MODULE_2__["default"].easeOutCubic
    }));
  ...
  initDropAnimations() {
    this.animationsLoop.push(new _animation_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
      func: (progress) => {
...
const IMAGES_URLS = Object.freeze({
  ...
  tree: `img/walrus/tree.png`,
  tree2: `img/walrus/tree2.png`,
  ice: `img/walrus/ice.png`,
  seaCalf: `img/walrus/sea-calf-2.png`,
  snowflake: `img/walrus/snowflake.png`
});
...
/***/ "./source/js/modules/show-animate-prizes.js":
/*!**************************************************!*\
  !*** ./source/js/modules/show-animate-prizes.js ***!
  \**************************************************/
/*! exports provided: showAnimatePrizes */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "showAnimatePrizes", function() { return showAnimatePrizes; });
/* harmony import */ var _show_count_prizes__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./show-count-prizes */ "./source/js/modules/show-count-prizes.js");
/* harmony import */ var _user_data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./user-data */ "./source/js/modules/user-data.js");
...
const showAnimatePrizes = () => {
  if (!doneAnimatePrizes) {
    ...
    setTimeout(() => prizeCases.style.visibility = "visible", 4200);
    const startAnimateCases = prizesContainer.querySelector('#startCases');
    startAnimateCases.beginElementAt(4.233);
    setTimeout(_show_count_prizes__WEBPACK_IMPORTED_MODULE_0__["showCountPrizes"], 5433, _user_data__WEBPACK_IMPORTED_MODULE_1__["prizesData"][0]);
    const prizeCodes = prizesContainer.querySelector('.prizes__item--codes');
    setTimeout(() => prizeCodes.style.visibility = "visible", 6633);
    const startAnimateCodes = prizesContainer.querySelector('#startCodes');
    startAnimateCodes.beginElementAt(6.666);
    setTimeout(_show_count_prizes__WEBPACK_IMPORTED_MODULE_0__["showCountPrizes"], 7600, _user_data__WEBPACK_IMPORTED_MODULE_1__["prizesData"][1]);
...
/***/ "./source/js/modules/show-count-prizes.js":
/*!************************************************!*\
  !*** ./source/js/modules/show-count-prizes.js ***!
  \************************************************/
/*! exports provided: showCountPrizes */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "showCountPrizes", function() { return showCountPrizes; });
const fps = 12;
...
/***/ "./source/js/modules/show-remaining-time.js":
/*!**************************************************!*\
  !*** ./source/js/modules/show-remaining-time.js ***!
  \**************************************************/
/*! exports provided: startTimer, stopTimer, done */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./source/js/modules/user-data.js":
/*!****************************************!*\
  !*** ./source/js/modules/user-data.js ***!
  \****************************************/
/*! exports provided: sectionHasTransitionEnd, accentTypographyData, animatedResultTitleData, prizesData */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sectionHasTransitionEnd", function() { return sectionHasTransitionEnd; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "accentTypographyData", function() { return accentTypographyData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "animatedResultTitleData", function() { return animatedResultTitleData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "prizesData", function() { return prizesData; });
...
/* harmony import */ var _modules_get_animated_titles__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/get-animated-titles */ "./source/js/modules/get-animated-titles.js");
// modules
...
Object(_modules_load_page__WEBPACK_IMPORTED_MODULE_9__["loadPage"])();
Object(_modules_get_animated_titles__WEBPACK_IMPORTED_MODULE_10__["getAnimatedTitles"])();
